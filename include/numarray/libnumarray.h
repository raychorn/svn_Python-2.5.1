...
#define libnumarray_API libnumarray_UNIQUE_SYMBOL
#endif
        ...
        if (module != NULL) {                                               \
          ...
          if (c_api_object && PyCObject_Check(c_api_object)) {              \
            ...
            PyErr_Format(PyExc_ImportError,                                 \
                         "Can't get API for module 'numarray.libnumarray'");  \
          }                                                                 \
        }                                                                   \
      }
      
#define import_libnumarray() _import_libnumarray(); if (PyErr_Occurred()) { PyErr_Print(); Py_FatalError("numarray.libnumarray failed to import... exiting.\n"); }
